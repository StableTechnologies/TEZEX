  ...
  return (
    <div className={classes.container}>
      <p>
        ...
        <b>TEZEX</b> provides complete Decentralized Atomic Swaps, it is not
        ...
        Currently TEZEX provides cross chain atomic swaps between Ethereum and
      ...
      <p className={classes.list}>
        ...
        <br /> 2. Swap Response Found : Swap response has been found and can
        proceed to completion. <br />
